  ...
  return knex(process.env.db_table).del()
    .then(function () {
      return knex(process.env.db_table).insert([
        ...
        { name: 'D\'Angelo Russell', jersey_number: '1', image: 'https://a.espncdn.com/combiner/i?img=/i/headshots/nba/players/full/3136776.png' },
        ...
        { name: 'Klay Thompson', jersey_number: '11', image: 'https://a.espncdn.com/combiner/i?img=/i/headshots/nba/players/full/6475.png' },
